...
public class MyAdapterDesayuno extends RecyclerView.Adapter<MyAdapterDesayuno.MyViewHolder> {
    ...
    public MyAdapterDesayuno(List<AlimentosAna> myDataset, OnListInteractionListener listener) {
        mDataset = myDataset;
        mListener = listener;
    }

    @Override
    public MyAdapterDesayuno.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
