...
public class Adaptercomidas extends RecyclerView.Adapter<Adaptercomidas.ViewHolder> {
    private List<Alimento> mDataset = new ArrayList<Alimento>();
    Context context;

    public Adaptercomidas(Context context) {
        context = context;
    }

    @NonNull
    @Override
    public Adaptercomidas.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        // create a new view
