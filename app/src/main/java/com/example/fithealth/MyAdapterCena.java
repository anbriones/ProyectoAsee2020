...
public class MyAdapterCena extends RecyclerView.Adapter<MyAdapterCena.MyViewHolder> {
...
public interface OnListInteractionListener{
    ...
    public MyAdapterCena.OnListInteractionListener mListener;
...
public static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyAdapterCena(List<AlimentosAna> myDataset, MyAdapterCena.OnListInteractionListener listener) {
        mDataset = myDataset;
        mListener = listener;
    }

    @Override
    public MyAdapterCena.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
        ...
        return new MyAdapterCena.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(final MyAdapterCena.MyViewHolder holder, int position) {
